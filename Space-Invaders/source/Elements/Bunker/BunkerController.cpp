...
namespace Element
{
    namespace Bunker
    {
        ...
        BunkerController::BunkerController() : bunker_view(std::make_unique<BunkerView>()) {}

        BunkerController::~BunkerController() {}

        void BunkerController::initialize(const BunkerData& data)
        {
            bunker_data = data;
        ...
        const sf::Sprite& BunkerController::getColliderSprite() const { return bunker_view->getBunkerSprite(); }
